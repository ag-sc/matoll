...
public class TestVerySimpleLexiconEvaluation {
    ...
    public static void main(String[] args){
        ...
        List<Double> result = VerySimpleLexiconEvaluation.evaluate(gold, gold);
        System.out.println("----------");
        System.out.println("Should be true:");
        System.out.println(result.get(0).equals(1.0)&&result.get(1).equals(1.0)&&result.get(2).equals(1.0));
        System.out.println("----------");
        
        result = VerySimpleLexiconEvaluation.evaluate(gold1, gold1);
        System.out.println("Should be true:");
        System.out.println(result.get(0).equals(1.0)&&result.get(1).equals(1.0)&&result.get(2).equals(1.0));
        System.out.println("----------");
        
        result = VerySimpleLexiconEvaluation.evaluate(gold, gold1);
        System.out.println("Should be false:");
        System.out.println(result.get(0).equals(1.0)&&result.get(1).equals(1.0)&&result.get(2).equals(1.0));
        System.out.println("----------");
        
        result = VerySimpleLexiconEvaluation.evaluate(gold1, gold);
        System.out.println("Should be false:");
        System.out.println(result.get(0).equals(1.0)&&result.get(1).equals(1.0)&&result.get(2).equals(1.0));
        System.out.println("----------");
        
        result = VerySimpleLexiconEvaluation.evaluate(lexicon1, gold);
        System.out.println("Should be true:");
