...
public class SparqlPattern_DE_Noun_Posessive_c extends SparqlPattern{

	
	Logger logger = LogManager.getLogger(SparqlPattern_DE_Noun_Posessive_c.class.getName());
	...
	@Override
	public String getID() {
		return "SparqlPattern_DE_Noun_Posessive_c";
	}
