...
18	Survivor	survivor	n	NP00000	_	15	DO
	...
	public void extractLexicalEntries(Model model, LexiconWithFeatures lexicon) {
		...
		if(adjective!=null && e1_arg!=null && e2_arg!=null && preposition!=null) {
                    Templates.getAdjective(model, lexicon, vector, sentences, adjective, e1_arg, e2_arg, preposition, this.getReference(model), logger, this.getLemmatizer(),Language.ES,getID());
            }
