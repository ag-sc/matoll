...
public class SparqlPattern_DE_Noun_Posessive_a extends SparqlPattern{

	
	Logger logger = LogManager.getLogger(SparqlPattern_DE_Noun_Posessive_a.class.getName());
	...
	@Override
	public String getID() {
		return "SparqlPattern_DE_Noun_Posessive_a";
	}
