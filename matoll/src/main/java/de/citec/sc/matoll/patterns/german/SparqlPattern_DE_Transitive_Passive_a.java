...
public class SparqlPattern_DE_Transitive_Passive_a extends SparqlPattern{

	
	Logger logger = LogManager.getLogger(SparqlPattern_DE_Transitive_Passive_a.class.getName());
	...
	@Override
	public String getID() {
		return "SparqlPattern_DE_Transitive_Passive_a";
	}
