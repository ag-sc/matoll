...
public class visualizeSPARQL {
    ...
    public static void main(String[] args){
        ...
        Patterns_EN.add(new SparqlPattern_EN_Noun_PP_copulativ());
        ...
        Patterns_ES.add(new SparqlPattern_ES_Noun_PP_copulativ());
        ...
        Patterns_DE.add(new SparqlPattern_DE_Transitive_Passive_optional());
