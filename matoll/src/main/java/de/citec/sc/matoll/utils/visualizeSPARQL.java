...
public class visualizeSPARQL {
    ...
    public static void main(String[] args){
        ...
        Patterns_DE.add(new SparqlPattern_DE_Noun_PP_a());
        Patterns_DE.add(new SparqlPattern_DE_Noun_Posessive_a());
        Patterns_DE.add(new SparqlPattern_DE_Noun_Posessive_b());
        Patterns_DE.add(new SparqlPattern_DE_Transitive());
        Patterns_DE.add(new SparqlPattern_DE_Transitive_Passive_a());
        Patterns_DE.add(new SparqlPattern_DE_Transitive_Passive_b());
        Patterns_DE.add(new SparqlPattern_DE_Intransitive_PP());
        Patterns_DE.add(new SparqlPattern_DE_Noun_PP_b());
        Patterns_DE.add(new SparqlPattern_DE_Noun_Posessive_c());
